...
Monito
Y = MUEVE MONITO HACIA ENFRENTE
H = MUEVE MONITO HACIA ATRAS
J = MUEVE MONITO DERECHA
G = MUEVE MONITO IZQUIERDA
B = MUEVE PIERNA DERECHA
P = ROTA MONITO
K = GUARDA KEYFRAMES
L = ACTIVA LA ANIMACION
I = ANIMACION DEL COCHE
R = ANIMACION DEL COCHE EN REVERSA
*/
